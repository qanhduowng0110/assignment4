...
// The ContactInfoFunc type is an adapter to allow the use of ordinary
// function as ContactInfo mutator.
type ContactInfoFunc func(context.Context, *ent.ContactInfoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ContactInfoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ContactInfoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ContactInfoMutation", m)
}
